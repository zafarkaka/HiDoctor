...
async def create_admin():
    ...
    if existing:
        print(f"Admin user {phone} already exists! Updating password...", flush=True)
        ...
        print(f"Updated existing user {phone} to admin with new password.", flush=True)
        client.close()
        return
        
    print(f"Creating admin user {phone}...", flush=True)
    ...
    print(f"Successfully created admin user!", flush=True)
